...
Процедура ОтправитьСообщения(Отправитель, МассивСообщений) Экспорт
...
Процедура ДобавитьСообщение(Отправитель, Сообщение, Топик, Ключ = Неопределено, Раздел = Неопределено) Экспорт
	...
	Отправитель.МассивСообщений.Добавить(НовоеСообщение);
...
Функция СвойстваОтправителя()
	...
	СтруктураОтправитея.Вставить("МассивСообщений", Новый Массив);
